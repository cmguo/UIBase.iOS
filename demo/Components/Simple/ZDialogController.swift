...
class ZDialogController: ComponentController, ZDialogCallback {
    ...
    private let dialog = ZDialog()
    private var views = [ZDialog]()
    ...
    func dialogDismissed(dialog: ZDialog) {
        if view.window != nil {
