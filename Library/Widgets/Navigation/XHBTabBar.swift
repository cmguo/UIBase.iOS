...
public protocol XHBTabBarIndicatorProtocol : JXSegmentedIndicatorProtocol {
    
}

public protocol XHBTabBarDelegate : JXSegmentedViewDelegate {
    
}

public class XHBTabBar : JXSegmentedView {
    ...
    public var indicator: (UIView & XHBTabBarIndicatorProtocol)? = nil {
        didSet {
    ...
    private let _style: XHBTabBarStyle
    
    public init(style: XHBTabBarStyle = .init()) {
        _style = style
