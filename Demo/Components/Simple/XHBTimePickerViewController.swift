//
//  XHBTimePickerViewController.swift
//  Demo
//
...
class XHBTimePickerViewController: ComponentController, XHBTimePickerViewCallback, XHBDatePickerViewCallback, XHBPanelCallbackDelegate {
    ...
    class Styles : ViewStyles {
        ...
        @objc static let _timeModeStyle: NSObject = EnumStyle(Styles.self, "timeMode", XHBTimePickerView.TimeMode.self)
        @objc var timeMode: Int = XHBTimePickerView.TimeMode.YearMonthDay.rawValue
    ...
    init(_ component: Component) {
        picker = component is XHBTimePickerViewComponent ? XHBTimePickerView() : XHBDatePickerView()
    ...
    func timePickerSelectTimeChanged(picker: XHBTimePickerView, time: Date) {
...
protocol TimePickerView : AnyObject {
    ...
    func setCallback(_ controller: XHBTimePickerViewController)
}

extension XHBTimePickerView : TimePickerView {
    var timeModeInt: Int {
...
extension XHBDatePickerView : TimePickerView {
    var timeModeInt: Int {
        get { return dateMode.rawValue }
        set {
            switch newValue {
            case XHBTimePickerView.TimeMode.YearMonthDay.rawValue:
                dateMode = .YearMonthDay
            case XHBTimePickerView.TimeMode.YearMonthWithDayWithWeek.rawValue:
