...
class XHBSearchBarController: ComponentController, UISearchBarDelegate {
    ...
    private let searchBar = XHBSearchBar()
    private var views = [XHBSearchBar]()
...
extension XHBSearchBarController : UITableViewDataSource {
